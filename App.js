   ...
   this.state.fontLoaded ? (
    ...
    {`${this.convertSecondsToCalendarDate()}`}
      ...
      <TouchableOpacity onPress={this.toggleInfoModal} style={{ height: 22}}>
       ...
       <Text style={{fontWeight: 'bold', color: 'white', paddingLeft: 20, paddingTop: 10}}>Weather2Wed was born from a vanilla Javascript project undertaken by <Text style={{color: '#a8a8a8'}} onPress={()=>Linking.openURL('https://github.com/jah1603')}>James Henderson</Text><Text style={{color: '#a8a8a8'}} onPress={()=>Linking.openURL('https://github.com/SFR1981')}>, Stephen Rooney</Text><Text style={{color: '#a8a8a8'}} onPress={()=>Linking.openURL('https://github.com/helenosheaa')}>, Helen O’Shea</Text> &<Text style={{color: '#a8a8a8'}} onPress={()=>Linking.openURL('https://github.com/DavidAPears')}> David Pears.</Text></Text>
        <Text style={{fontWeight: 'bold', color: 'white', padding: 20}}> The project formed part of the <Text style={{color: '#a8a8a8'}} onPress={()=>Linking.openURL('https://codeclan.com')}>CodeClan</Text> Software Development course. The original web app can still be seen <Text style={{color: '#a8a8a8'}} onPress={()=>Linking.openURL('https://weather2wed.herokuapp.com')}>here</Text>. Then - James, Stephen and David holed themselves up in an Edinburgh cafe to convert Weather2Wed into <Text style={{color: '#a8a8a8'}} onPress={()=>Linking.openURL('www.reactnative.com')}>ReactNative</Text> (teaching themselves the language in the process).  Several hundred cups of coffee later; the result is this App.</Text>

       <Text style={{fontWeight: 'bold', color: 'white', paddingLeft: 20, paddingBottom: 10}}>Weather2Wed’s aim is to allow bride and grooms to asses the weather for their potential wedding date - at any UK location. Powered by <Text style={{color: '#a8a8a8'}} onPress={()=>Linking.openURL('https://darksky.net/')}>Dark Sky</Text>; the app returns the average/typical weather (based on historical weather data) for any given location in the UK. The app utilises <Text style={{color: '#a8a8a8'}} onPress={()=>Linking.openURL('https://www.geograph.org.uk/')}>Geograph's API</Text> which means that 95% of the UK can be entered as a search term (the fuzzy search allows for place name, postcode, region or even landmark). Weather2Wed also suggests hotels in and around a prospective wedding venue using the <Text style={{color: '#a8a8a8'}} onPress={()=>Linking.openURL('https://developer.foursquare.com/places-api')}>FourSquare API</Text>. There is no commercial benefit to us, the creators, this information is provided as a free service. </Text>

       <Text style={{fontWeight: 'bold', color: 'white', paddingLeft: 20}}>Weather2Wed</Text>

       <Text style={{fontWeight: 'bold', color: 'white', paddingBottom: 5, paddingLeft: 20}}>November 2018</Text>
