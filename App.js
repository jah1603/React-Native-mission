   ...
   this.state.fontLoaded ? (
    ...
    {`${this.convertSecondsToCalendarDate()}`}
      ...
      <TouchableOpacity onPress={this.toggleInfoModal} style={{ height: 22}}>
       ...
       <Text style={{color: 'white', paddingLeft: 20, paddingTop: 10}}>Weather2Wed was born from a vanilla Javascript project undertaken by <Text style={{color: '#0050A1'}} onPress={()=>Linking.openURL('https://github.com/jah1603')}>James Henderson</Text><Text style={{color: '#0050A1'}} onPress={()=>Linking.openURL('https://github.com/SFR1981')}>, Stephen Rooney</Text><Text style={{color: '#0050A1'}} onPress={()=>Linking.openURL('https://github.com/helenosheaa')}>, Helen O’Shea</Text> &<Text style={{color: '#0050A1'}} onPress={()=>Linking.openURL('https://github.com/DavidAPears')}> David Pears.</Text></Text>
        <Text style={{color: 'white', padding: 20}}> The project formed part of the CodeClan Software Development course. The original web app can still be seen here. Then - James, Stephen and David holed themselves up in an Edinburgh cafe to convert Weather2Wed into ReactNative (teaching themselves the language in the process).  Several hundred cups of coffee later; the result is this App.</Text>
